...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      home: authState.when(data: (data) => data.user!=null ?const HomePage():const LoginPage(), error: (error, stackTrace) => const Text('error'), loading: () => const CircularProgressIndicator(),),
    );
  }
}
